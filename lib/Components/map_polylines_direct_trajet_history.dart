...
class MapScreenWithPolylineDirectTrajetHistory extends StatefulWidget {
  final List<LatLng> polylineCoordinates;
  final LatLng departMarker;
  final LatLng arriveMarker;
  final RouteInfo routeInfo;
  final numero;
  const MapScreenWithPolylineDirectTrajetHistory(
      {super.key,
  ...
  @override
  State<MapScreenWithPolylineDirectTrajetHistory> createState() =>
      _MapScreenWithPolylineDirectTrajetHistoryState();
}

class _MapScreenWithPolylineDirectTrajetHistoryState
    extends State<MapScreenWithPolylineDirectTrajetHistory> {
            ...
            child: SingleChildScrollView(
              ...
              child: Row(
                children: [
                  ...
                  LegendItem(
                    icon: Icons.location_pin,
                    iconColor: Color.fromARGB(255, 0, 13, 255),
                    text:
                        'Position à l\'enregistrement', // Texte plus court en français
                  ),
                  // LegendItem(
      ...
      child: FlutterMap(
        ...
        children: [
          ...
          MarkerLayer(
            markers: [
              Marker(
                point: widget.routeInfo.coordinates.last,
                width: 20,
                height: 20,
